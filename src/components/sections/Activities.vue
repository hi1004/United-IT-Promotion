          ...
          <div class="banner first__banner">
            <div class="content">
              ...
              <p class="slide__paragraph back-to-position to-top delay-2">
                <span>저희 동아리는 다양한 플랫폼에서 쓰이고 있는 자바 언어를 기본으로 스터디를 진행하고 있습니다.</span> 
                개별로 진행되던 스터디를 하나로 통합하여 실력 편차를 최소한으로 하며 누구나 개발 경험을
                쌓을 수 있는 스터디로 준비했습니다. 또한 <span>최근에는 웹 개발에 관심있는 분들이 늘어나
                  프론트엔드 스터디를 기획하여, 레이아웃부터 자바스크립트 나아가 다양한 라이브러리를
                  활용할 수 있도록 하고 있습니다.</span>
              </p>
            </div>
          </div>
        </section>
          ...
          <div class="banner second__banner">
            <div class="content">
              ...
              <p class="slide__paragraph back-to-position to-top delay-2">
                ...
                그래서 <span>저희 동아리에서는 학교에 있는 일본인 유학생들을 모아 
        ...
        <section class="slide__content third">
          <div class="banner third__banner">
            <div class="content">
              ...
              <p class="slide__paragraph back-to-position to-top delay-2">
                <span>일본 취업을 희망하는 친구들을 모아 일본 취업에 필요한 정보들을 공유하며 더 나아가 이력서 첨삭,
                  모의 면접까지 진행하고 있습니다. 
